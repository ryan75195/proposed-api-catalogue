# Local Climate Trend API

I need a smoothed temperature or rainfall trend for a location over recent years. Planners and farmers want to know whether a location's climate is changing beyond year-to-year noise, but raw station data is noisy and hard to summarise.

Local Climate Trend API returns a smoothed trend for a temperature or rainfall metric at a location. A call to GET /trend?postcode=...&metric=tmax&since=2000 returns { "deltaC": 0.6, "direction": "warming", "years": 24 }.
